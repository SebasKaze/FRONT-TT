        ...
        <div className="p-6">
            ...
            <section>
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="flex flex-col items-center text-center">
                        <label className="mb-2" htmlFor="dest_ori">Destino/Origen</label>
                        <select  className="w-full border border-gray-300 rounded p-2 bg-white" 
                        name="dest_ori"
                        onChange={handleChange}
                        >
                    ...
                    <div className="flex flex-col items-center text-center">
                        <label className="mb-2" htmlFor="t_cambio">Tipo de cambio</label>
                    ...
                    <div className="flex flex-col items-center text-center">
                        <label className="mb-2" htmlFor="peso_br">Peso bruto (kg)</label>
                    ...
                    <div className="flex flex-col items-center text-center">
                        <h3><span className="text-xl text-black">Fechas</span></h3>
