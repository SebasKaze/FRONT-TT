                ...
                <div>
                    {sections.map((section) => (
                        <div key={section.id} className="mb-6">
                            <div className="grid grid-cols-4 gap-6 bg-gray-100 w-9/12 mx-auto p-6 rounded-xl shadow-sm">
                            ...
                            {section.contributions.map((contribution) => (
                                <div key={contribution.id} className="grid grid-cols-4 gap-6 bg-gray-50 w-9/12 mx-auto p-6 rounded-xl shadow-sm ">
                                    <div className="flex flex-col items-center text-center">
                                    ...
                                    <div className="col-span-5 text-right">
                                        <button
                                            className="bg-red-300 hover:bg-red-400 text-white font-semibold py-2 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1"
                            ...
                            <div className="mb-4 text-center">
                                <button
                                    className="bg-blue-400 hover:bg-blue-500 text-white font-semibold py-2 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1"
                            ...
                            <div className="text-right">
                                <button
                                    className="bg-red-400 hover:bg-red-500 text-white font-semibold py-2 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1"
