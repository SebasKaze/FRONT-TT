...
function Registro() {   
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${backConection}/api/registrarempresa`, {
                method: "POST",
                headers: {
        ...
        <div className="max-w-6xl mx-auto bg-gray-100 p-5 rounded-xl">
            ...
            <div className="p-6">
                ...
                <form onSubmit={handleSubmitDomi} className="flex flex-col gap-4 px-4">
                    ...
                    <textarea
                        ...
                        className="w-full border rounded-md p-4 focus:outline-none focus:ring focus:ring-green-300 resize-none"
            ...
            <div className="p-6">
                ...
                <form className="grid grid-cols-5 gap-4" onSubmit={handleSubmitUsuario}>
                    ...
                    {/* Botón de envío */}
                    <div className="flex justify-center p-4">
                    <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1" disabled={!domicilioSeleccionado}>
                        Agregar
                    </button>
                    </div>
                </form>
